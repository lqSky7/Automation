tell application "Reminders"
    ...
    -- *** REMOVE OR COMMENT OUT THE CLEARING STEP ***
    ...
    -- Copy each reminder to the target list, but only if a reminder with the same name doesn't already exist to avoid duplicates
    ...
    repeat with aReminder in sourceReminders
        -- Add only if it doesn't already exist in targetList by title
